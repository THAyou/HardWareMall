...
//-- File: Bll/Base/BllM_OtherConfig.cs
//-- 2020/3/12 13:44:19
//------------------
using System;
...
{
    public abstract class BllM_OtherConfig:Bll.Base.BaseBll
    {
        protected readonly Dal.HardwareMall.DalM_OtherConfig dal = Dal.HardwareMall.DalM_OtherConfig.Instance();

        public BllM_OtherConfig() { }

        /// <summary>
        /// 实例化一个当前逻辑操作对象
        /// </summary>
        /// <returns></returns>
        public static Bll.HardwareMall.BllM_OtherConfig Instance()
        {
            return new Bll.HardwareMall.BllM_OtherConfig();
        }
        /// <summary>
        /// 增加记录并且返回当前信息ID
        /// </summary>
