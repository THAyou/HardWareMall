...
//-- File: Bll/Base/BllM_PriceType.cs
//-- 2020/3/16 14:29:53
//------------------
using System;
...
{
    public abstract class BllM_PriceType:Bll.Base.BaseBll
    {
        protected readonly Dal.HardwareMall.DalM_PriceType dal = Dal.HardwareMall.DalM_PriceType.Instance();

        public BllM_PriceType() { }

        /// <summary>
        /// 实例化一个当前逻辑操作对象
        /// </summary>
        /// <returns></returns>
        public static Bll.HardwareMall.BllM_PriceType Instance()
        {
            return new Bll.HardwareMall.BllM_PriceType();
        }
        /// <summary>
        /// 增加记录并且返回当前信息ID
        /// </summary>
