...
{
    public abstract class BllM_News:Bll.Base.BaseBll
    {
        protected readonly Dal.HardwareMall.DalM_News dal = Dal.HardwareMall.DalM_News.Instance();
        ...
        /// </summary>
        /// <returns></returns>
        public static Bll.HardwareMall.BllM_News Instance()
        {
            return new Bll.HardwareMall.BllM_News();
        }
        /// <summary>
        /// 增加记录并且返回当前信息ID
        /// </summary>
