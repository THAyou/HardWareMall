...
//-- File: Bll/Base/BllM_HomeElement.cs
//-- 2020/3/11 15:24:40
//------------------
using System;
...
{
    public abstract class BllM_HomeElement:Bll.Base.BaseBll
    {
        protected readonly Dal.HardwareMall.DalM_HomeElement dal = Dal.HardwareMall.DalM_HomeElement.Instance();

        public BllM_HomeElement() { }

        /// <summary>
        /// 实例化一个当前逻辑操作对象
        /// </summary>
        /// <returns></returns>
        public static Bll.HardwareMall.BllM_HomeElement Instance()
        {
            return new Bll.HardwareMall.BllM_HomeElement();
        }
        /// <summary>
        /// 增加记录并且返回当前信息ID
        /// </summary>
