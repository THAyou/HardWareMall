...
//-- File: Bll/Base/BllM_ProductRe.cs
//-- 2020/3/23 18:08:50
//------------------
using System;
...
{
    public abstract class BllM_ProductRe:Bll.Base.BaseBll
    {
        protected readonly Dal.HardwareMall_Chinese.DalM_ProductRe dal = Dal.HardwareMall_Chinese.DalM_ProductRe.Instance();

        public BllM_ProductRe() { }

        /// <summary>
        /// 实例化一个当前逻辑操作对象
        /// </summary>
        /// <returns></returns>
        public static Bll.HardwareMall_Chinese.BllM_ProductRe Instance()
        {
            return new Bll.HardwareMall_Chinese.BllM_ProductRe();
        }
        /// <summary>
        /// 增加记录并且返回当前信息ID
        /// </summary>
