...
{
    public abstract class BllW_Product:Bll.Base.BaseBll
    {
        protected readonly Dal.HardwareMall.DalW_Product dal = Dal.HardwareMall.DalW_Product.Instance();
        ...
        /// </summary>
        /// <returns></returns>
        public static Bll.HardwareMall.BllW_Product Instance()
        {
            return new Bll.HardwareMall.BllW_Product();
        }
        /// <summary>
        /// 增加记录并且返回当前信息ID
        /// </summary>
