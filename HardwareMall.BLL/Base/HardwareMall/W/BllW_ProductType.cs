...
//-- File: Bll/Base/BllW_ProductType.cs
//-- 2020/3/6 14:31:08
//------------------
using System;
...
{
    public abstract class BllW_ProductType:Bll.Base.BaseBll
    {
        protected readonly Dal.HardwareMall.DalW_ProductType dal = Dal.HardwareMall.DalW_ProductType.Instance();

        public BllW_ProductType() { }

        /// <summary>
        /// 实例化一个当前逻辑操作对象
        /// </summary>
        /// <returns></returns>
        public static Bll.HardwareMall.BllW_ProductType Instance()
        {
            return new Bll.HardwareMall.BllW_ProductType();
        }
        /// <summary>
        /// 增加记录并且返回当前信息ID
        /// </summary>
