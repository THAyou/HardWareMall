...
//-- File: Bll/Base/BllW_ProductImg.cs
//-- 2020/3/9 14:05:43
//------------------
using System;
...
{
    public abstract class BllW_ProductImg:Bll.Base.BaseBll
    {
        protected readonly Dal.HardwareMall.DalW_ProductImg dal = Dal.HardwareMall.DalW_ProductImg.Instance();

        public BllW_ProductImg() { }

        /// <summary>
        /// 实例化一个当前逻辑操作对象
        /// </summary>
        /// <returns></returns>
        public static Bll.HardwareMall.BllW_ProductImg Instance()
        {
            return new Bll.HardwareMall.BllW_ProductImg();
        }
        /// <summary>
        /// 增加记录并且返回当前信息ID
        /// </summary>
