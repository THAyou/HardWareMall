...
//-- File: Bll/Base/BllW_ProductFormat.cs
//-- 2020/5/6 15:52:53
//------------------
using System;
...
{
    public abstract class BllW_ProductFormat: Bll.Base.BaseBll
    {
        protected readonly Dal.HardwareMall.DalW_ProductFormat dal = Dal.HardwareMall.DalW_ProductFormat.Instance();

        public BllW_ProductFormat() { }

        /// <summary>
        /// 实例化一个当前逻辑操作对象
        /// </summary>
        /// <returns></returns>
        public static Bll.HardwareMall.BllW_ProductFormat Instance()
        {
            return new Bll.HardwareMall.BllW_ProductFormat();
        }
        /// <summary>
        /// 增加记录并且返回当前信息ID
        /// </summary>
