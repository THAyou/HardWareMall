...
//-- File: Bll/Base/BllW_ProductAndType.cs
//-- 2020/3/10 15:12:59
//------------------
using System;
...
{
    public abstract class BllW_ProductAndType:Bll.Base.BaseBll
    {
        protected readonly Dal.HardwareMall.DalW_ProductAndType dal = Dal.HardwareMall.DalW_ProductAndType.Instance();

        public BllW_ProductAndType() { }

        /// <summary>
        /// 实例化一个当前逻辑操作对象
        /// </summary>
        /// <returns></returns>
        public static Bll.HardwareMall.BllW_ProductAndType Instance()
        {
            return new Bll.HardwareMall.BllW_ProductAndType();
        }
        /// <summary>
        /// 增加记录并且返回当前信息ID
        /// </summary>
